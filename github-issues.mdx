...
- To index your codebase locally, [set up Marqo](/local#optional-index-the-codebase-with-marqo).
- Alternatively, for a managed vector store, [set up Pinecone](/quality#setting-up-the-vector-store).
